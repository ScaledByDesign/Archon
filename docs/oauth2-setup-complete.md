...
- **Provider ID**: `3`
- **Redirect URI**: `http://zoi.local:8000/api/auth/callback` (strict matching)
...
```json
{
  "redirect_uris": [
    {
      "url": "http://zoi.local:8000/api/auth/callback",
...
- **Response Type**: `code`
- **Client ID**: `fastapi-client`
- **Redirect URI**: `http://zoi.local:8000/api/auth/callback`
...
### Manual Testing
1. Open browser to: `http://zoi.local:8000/api/auth/login`
