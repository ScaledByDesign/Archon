...
LITELLM_BASE_URL = os.getenv("LITELLM_BASE_URL", "http://127.0.0.1:7010")
LITELLM_API_KEY = os.getenv("LITELLM_API_KEY", "sk-6df5295f77391ff7611a0fab11b989287012f48e46f58ae0")
...
class LLM:
    ...
    def __init__(
        ...
        self.effective_openai_key = self._api_key or OPENAI_API_KEY or LITELLM_API_KEY
        ...
        # For OpenAI backend, use LiteLLM proxy if no specific base_url provided
        self.effective_openai_base_url = self._base_url if self.backend == "openai" and self._base_url else (LITELLM_BASE_URL + "/v1" if self.backend == "openai" else None)
